...
const Testimonials: React.FC = () => {
  return (
    <div className="w-full max-w-6xl mx-auto p-6">
      <h2 className="text-6xl sm:text-7xl md:text-7xl lg:text-8xl xl:text-9xl font-medium title-font mb-4 golden-text text-center">What They Say</h2>
      <Swiper
        modules={[Autoplay]}
        spaceBetween={50}
        slidesPerView={1}
      ...
      >
        {testimonials.map((testimonial, index) => (
          <SwiperSlide key={index}>
            <div className="flex flex-col items-center h-full pt-10 pb-10">
              <div className="w-full h-auto flex-shrink-0 flex justify-center">
                <div className="relative items-center" style={{ width: '80%', paddingBottom: '35.25%' }}>
                  <Image
                    src={testimonial.gif}
              ...
              <div className="w-full px-10 py-4 flex-grow flex items-center justify-center">
                <p className="text-lg sm:text-xl md:text-2xl text-center">
                  <FaQuoteLeft className="inline-block mr-2 text-gray-500" />
                  {testimonial.text}
                  <FaQuoteRight className="inline-block ml-2 text-gray-500" />
                </p>
              </div>
            </div>
          </SwiperSlide>
